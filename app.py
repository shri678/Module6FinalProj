...
app.layout = html.Div([
    html.Div([
              html.Img(src = "https://raw.githubusercontent.com/shri678/DataViz1/master/Daco_4377152.png",style={'height':'5%', 'width':'10%', 'display': 'inline-block','text-align': 'left'}),
              html.H1("Cricket Statistics",style={'height':'5%', 'width':'90%', 'display': 'inline-block', 'text-align': 'center', 'vertical-align': 'middle'}),
